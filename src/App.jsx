...
function App() {
  ...
  return (
    {
      /* Ferah fildişi ve krem tonlarında arka plan */
    },
    (
      <div className="min-h-screen flex flex-col items-center justify-center bg-linear-to-br from-[#FAF5F0] via-white to-[#FDF4E3] overflow-x-hidden text-slate-700 px-4 py-32 md:py-40 relative font-['Playfair_Display']">
        ...
        {/* --- BLUR EFEKTİ (Buzlu Cam - Çiçeklerin arkasında, sayfanın alt ve üstünde) --- */}
        {/* Üst Blur: 20px bulanıklık, aşağı doğru yumuşakça şeffaflaşır */}
        <div
        ...
        {/* Alt Blur: 20px bulanıklık, yukarı doğru yumuşakça şeffaflaşır */}
        <div
        ...
        {/* --- ÇİÇEK GÖRSELLERİ (Transparan Şekilde En Üstte) --- */}
